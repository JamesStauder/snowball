...
class IceCube():
    def __init__(self, fileName, timeEnd, timeStep):
        ...
        self.sts = Stresses(self.U, self.Hmid, self.H0, self.H, self.width, self.B, self.S, self.Phi)
        ...
        df.set_solver_options(self.coupled_solver)
